...
const TICKERS = [
  { ticker: "NVDA", name: "엔비디아", color: "#76b900", emoji: "🟢" },
  { ticker: "TSLA", name: "테슬라", color: "#ef4444", emoji: "🔴" },
  { ticker: "SMCI", name: "슈퍼마이크로", color: "#8b5cf6", emoji: "🟣" },
  { ticker: "MSFT", name: "마이크로소프트", color: "#00a4ef", emoji: "🔵" },
  { ticker: "AAPL", name: "애플", color: "#a3a3a3", emoji: "⚪" },
  { ticker: "AMZN", name: "아마존", color: "#ff9900", emoji: "🟠" },
  { ticker: "META", name: "메타", color: "#1877f2", emoji: "🔵" },
  { ticker: "GOOGL", name: "구글", color: "#4285f4", emoji: "🔵" },
];
